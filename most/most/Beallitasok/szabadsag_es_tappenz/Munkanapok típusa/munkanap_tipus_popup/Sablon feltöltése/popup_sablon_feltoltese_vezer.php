...
include __DIR__ . '/popup_sablon_feltoltese_popup.html';
...
$scriptFeltoltGomb = 'Beallitasok/szabadsag_es_tappenz/Munkanapok típusa/munkanap_tipus_popup/Sablon feltöltése/popup_sablon_feltoltese_popup.js';
echo "<script src='{$scriptFeltoltGomb}?v=" . time() . "'></script>";
?>
