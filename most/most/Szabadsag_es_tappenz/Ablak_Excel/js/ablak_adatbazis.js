...
function megjelenitoFugveny(adatok, opSzam, kellFrissites = true) {
    ...
    adatok.forEach(function(rekord) {
      ...
      const vizsgalt = nyers.toLowerCase();
        let tipusClass = 'egyeb';
        if (vizsgalt.indexOf('fizetés nélküli') > -1 || vizsgalt.indexOf('fn') > -1) tipusClass = 'fizetes-nelkuli-szabadsag';
        else if (vizsgalt.indexOf('táppénz (gyáp)') > -1) tipusClass = 'tappenz-gyap';
        else if (vizsgalt.indexOf('táppénz') > -1 || vizsgalt.indexOf('tp') > -1) tipusClass = 'tappenz';
        else if (vizsgalt.indexOf('tanulmányi') > -1) tipusClass = 'tanulmanyi-szabadsag';
        else if (vizsgalt.indexOf('közeli hozzátartozó') > -1) tipusClass = 'kozeli-hozzatartozo-halala-miatt';
        else if (vizsgalt.indexOf('szabadság') > -1 || vizsgalt.indexOf('sz') > -1) tipusClass = 'rendes-szabadsag';
        else if (vizsgalt.indexOf('adat') > -1 || vizsgalt.indexOf('a') > -1) tipusClass = 'rendszer-adat';

        // RÖVIDÍTETT KÓD KÉSZÍTÉSE A CELLÁBA
        ...
        if (statuszKod.toLowerCase().includes('hozzátartozó')) statuszKod = 'SZ';
        if (statuszKod.includes('Táppénz')) statuszKod = 'TP';
