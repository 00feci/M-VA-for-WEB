...
window.nyisdMegAPopupot = function(cella) {
    ...
    if (!overlay) {
        ...
        overlay.innerHTML = `
            <style>
                ...
                /* 🎨 VISSZAÁLLÍTOTT SZÍNEK: Kék SZ, Piros TP, Világoskék A */
                .kod-preview.rendes-szabadsag { background: #2196F3 !important; color: white !important; }
                .kod-preview.tappenz { background: #f44336 !important; color: white !important; }
                .kod-preview.rendszer-adat { background: #e3f2fd !important; color: #0d47a1 !important; }
                .kod-preview.fizetes-nelkuli-szabadsag { background: #9e9e9e !important; color: white !important; }
            </style>
    ...
    reszek.forEach(resz => {
        ...
        felsorolas.push(`<b>${resz} (${n} nap)</b>`);
    });
