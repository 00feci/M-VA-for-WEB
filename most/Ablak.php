...
<script src="js/ablak_kinezet.js?v=<?php echo filemtime(__DIR__ . '/js/ablak_kinezet.js'); ?>"></script>
<script src="js/ablak_felepetes.js?v=<?php echo filemtime(__DIR__ . '/js/ablak_felepetes.js'); ?>"></script>
<script src="js/ablak_adatbazis.js?v=<?php echo filemtime(__DIR__ . '/js/ablak_adatbazis.js'); ?>"></script>
